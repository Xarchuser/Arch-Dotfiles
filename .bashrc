...
# Excluir os pacores com depencias
alias pacR='sudo pacman -R'

# Excluir os pacotes sem dependencias
...
#Procurar arquivos no repositorio
...
alias google='ping -c 3 www.google.com.br' # Ping ao google a cada 3 segundos
alias uol='ping -c 3 www.uol.com.br' # Ping ao UOL a cada 3 segundos
#colocar cd automaticmente
#shopt -s autocd
#diretorios em arvores
alias sl='tree -h -L 1'
#apagar tela no terminal
alias c=clear
...
function cd() { builtin cd -- "$@" && { [ "$PS1" = "" ] || tree -h -L 1; }; }
...
# Alias para o neofetch

alias neo='neofetch --w3m  ~/Imagens/w3m/ai.png'

# Desisntalar aplicativos 

alias unistall='expac -HM "%011m\t%-20n\t%10d"$(comm -23 <(pacman -Qqen | sort) <(pacman -Qqg base base-devel | sort)) | sort -n'

#programas iniciados no lxde

alias autostart='sudo nano /home/xtreme/.config/lxsession/LXDE/autostart'

#tela cheia, matar polybar

alias f11='sudo killall polybar'
